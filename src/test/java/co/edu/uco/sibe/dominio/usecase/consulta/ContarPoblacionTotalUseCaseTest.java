...
class ContarPoblacionTotalUseCaseTest {
    ...
    private ContarPoblacionTotalUseCase useCase;

    @BeforeEach
    void setUp() {
        useCase = new ContarPoblacionTotalUseCase(actividadRepositorioConsulta, autorizacionServicio);
    }
    ...
    void deberiaRetornarResultadoExitosamenteSinFiltroOrganizacional() {
        ...
        when(actividadRepositorioConsulta.contarPoblacionTotal(filtro)).thenReturn(100L);
    ...
    void deberiaRetornarResultadoExitosamenteConFiltroDeArea() {
        ...
        FiltroEstadisticaDTO filtro = new FiltroEstadisticaDTOTestDataBuilder()
                ...
                .conTipoArea("AREA")
                .construir();
        when(actividadRepositorioConsulta.contarPoblacionTotal(filtro)).thenReturn(50L);
    ...
    void deberiaRetornarResultadoExitosamenteConFiltroDeDireccion() {
        ...
        FiltroEstadisticaDTO filtro = new FiltroEstadisticaDTOTestDataBuilder()
                ...
                .construir();
        when(actividadRepositorioConsulta.contarPoblacionTotal(filtro)).thenReturn(30L);
    ...
    void deberiaRetornarResultadoExitosamenteConFiltroDeSubarea() {
        ...
        FiltroEstadisticaDTO filtro = new FiltroEstadisticaDTOTestDataBuilder()
                ...
                .conTipoArea("SUBAREA")
                .construir();
        when(actividadRepositorioConsulta.contarPoblacionTotal(filtro)).thenReturn(20L);
