...
class ContarAsistenciasTotalesUseCaseTest {
    ...
    private ContarAsistenciasTotalesUseCase useCase;

    @BeforeEach
    void setUp() {
        useCase = new ContarAsistenciasTotalesUseCase(actividadRepositorioConsulta, autorizacionServicio);
    }
    ...
    void deberiaRetornarResultadoExitosamenteSinFiltroOrganizacional() {
        ...
        when(actividadRepositorioConsulta.contarAsistenciasTotales(filtro)).thenReturn(100L);
    ...
    void deberiaRetornarResultadoExitosamenteConFiltroDeArea() {
        ...
        FiltroEstadisticaDTO filtro = new FiltroEstadisticaDTOTestDataBuilder()
                ...
                .conTipoArea("AREA")
                .construir();
        when(actividadRepositorioConsulta.contarAsistenciasTotales(filtro)).thenReturn(50L);
    ...
    void deberiaRetornarResultadoExitosamenteConFiltroDeDireccion() {
        ...
        FiltroEstadisticaDTO filtro = new FiltroEstadisticaDTOTestDataBuilder()
                ...
                .construir();
        when(actividadRepositorioConsulta.contarAsistenciasTotales(filtro)).thenReturn(30L);
    ...
    void deberiaRetornarResultadoExitosamenteConFiltroDeSubarea() {
        ...
        FiltroEstadisticaDTO filtro = new FiltroEstadisticaDTOTestDataBuilder()
                ...
                .conTipoArea("SUBAREA")
                .construir();
        when(actividadRepositorioConsulta.contarAsistenciasTotales(filtro)).thenReturn(20L);
