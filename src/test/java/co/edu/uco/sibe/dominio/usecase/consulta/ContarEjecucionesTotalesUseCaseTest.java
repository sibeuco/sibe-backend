...
class ContarEjecucionesTotalesUseCaseTest {
    ...
    private ContarEjecucionesTotalesUseCase useCase;

    @BeforeEach
    void setUp() {
        useCase = new ContarEjecucionesTotalesUseCase(actividadRepositorioConsulta, autorizacionServicio);
    }
    ...
    void deberiaRetornarResultadoExitosamenteSinFiltroOrganizacional() {
        ...
        when(actividadRepositorioConsulta.contarEjecucionesTotales(filtro)).thenReturn(100L);
    ...
    void deberiaRetornarResultadoExitosamenteConFiltroDeArea() {
        ...
        FiltroEstadisticaDTO filtro = new FiltroEstadisticaDTOTestDataBuilder()
                ...
                .conTipoArea("AREA")
                .construir();
        when(actividadRepositorioConsulta.contarEjecucionesTotales(filtro)).thenReturn(50L);
    ...
    void deberiaRetornarResultadoExitosamenteConFiltroDeDireccion() {
        ...
        FiltroEstadisticaDTO filtro = new FiltroEstadisticaDTOTestDataBuilder()
                ...
                .construir();
        when(actividadRepositorioConsulta.contarEjecucionesTotales(filtro)).thenReturn(30L);
    ...
    void deberiaRetornarResultadoExitosamenteConFiltroDeSubarea() {
        ...
        FiltroEstadisticaDTO filtro = new FiltroEstadisticaDTOTestDataBuilder()
                ...
                .conTipoArea("SUBAREA")
                .construir();
        when(actividadRepositorioConsulta.contarEjecucionesTotales(filtro)).thenReturn(20L);
