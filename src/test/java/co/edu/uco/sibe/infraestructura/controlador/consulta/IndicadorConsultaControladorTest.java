...
class IndicadorConsultaControladorTest {
    ...
    void deberiaConsultarTodosPaginado() {
        RespuestaPaginada<IndicadorDTO> respuesta = new RespuestaPaginada<>(List.of(), 0L, 0, 0);
        when(consultarIndicadoresManejador.ejecutar(any(SolicitudPaginacion.class))).thenReturn(respuesta);

        RespuestaPaginada<IndicadorDTO> resultado = controlador.consultarTodosPaginado(0, 10, null, null, null);
