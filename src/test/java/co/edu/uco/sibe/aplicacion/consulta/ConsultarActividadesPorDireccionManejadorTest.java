...
class ConsultarActividadesPorDireccionManejadorTest {
    ...
    @Test
    void deberiaConsultarActividadesPorDireccionPaginadas() {
        ...
        when(consultarActividadesPorDireccionUseCase.ejecutar("direccion1", solicitud)).thenReturn(respuesta);

        RespuestaPaginada<ActividadDTO> resultado = manejador.ejecutar("direccion1", solicitud);
