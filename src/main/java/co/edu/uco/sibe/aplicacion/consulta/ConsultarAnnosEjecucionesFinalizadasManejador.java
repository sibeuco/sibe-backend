...
@Component
@AllArgsConstructor
public class ConsultarAnnosEjecucionesFinalizadasManejador implements ManejadorRespuesta<List<String>> {
    private final ConsultarAnnosEjecucionesFinalizadasUseCase useCase;
