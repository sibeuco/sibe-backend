...
@Component
@AllArgsConstructor
public class ContarPoblacionTotalManejador implements ManejadorComandoRespuesta<FiltroEstadisticaDTO, Long> {
    private final ContarPoblacionTotalUseCase useCase;
